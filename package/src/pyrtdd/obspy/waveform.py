"""obspy-backed implementations of `pyrtdd.hdd.WaveformProxy`.
...
from pyrtdd.hdd import WaveformProxy, Trace, ThreeComponents
...
class _ObspyProxyBase(WaveformProxy):
